...
# %%
res_diff = pd.read_csv('results/res_diff.csv', index_col=0)
res_com = pd.read_csv('results/res_com.csv', index_col=0)
res_whole = pd.read_csv('results/res_whole.csv', index_col=0)
